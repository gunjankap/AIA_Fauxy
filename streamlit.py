...
if generate_btn:
   ...
   with st.spinner("🎭 Finalizing your satire..."):
    ...
    try:
        ...
        # ================= AGENT PLAN =================
        risk = "low"
        selected_tone = tone if tone != "auto" else random.choice([
            "dry sarcasm",
            "political parody",
            "subtle irony"
        ])
        ...
        # ================= PROMPT =================
        prompt = f"""
You are a sarcastic Indian satirical reporter from 'The Fauxy'.

REAL NEWS:
{factual_content}

Write a {selected_tone} satire article explaining the real absurdity behind this news.
Use witty Indian humor, irony and exaggeration.
"""
        ...
        satire = ollama_data.get("response", "No satire generated.")
        ...
        evaluation = {
            ...
            "reasons": [
                "Satire grounded in real news context",
                "Humor derived from exaggeration and irony",
        ...
        st.stop() with st.spinner("🎭 Finalizing your satire..."):
        try:
